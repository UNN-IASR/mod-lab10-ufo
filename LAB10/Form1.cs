...
namespace LAB10
{
    public partial class Form1 : Form
    {
        ...
        {
            int[] arr = obj as int[];
            int x2 = arr[0], y2 = arr[1], n = arr[2], error = arr[3];
            int x1 = 0, y1 = 0;
            double x = 0, y = 0;
            int step = 5;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "" ||textBox2.Text == "" || textBox3.Text == "" || textBox4.Text == "")
            {
                ...
                thread.Start(new int[] { Int32.Parse(textBox1.Text), Int32.Parse(textBox2.Text),
                                 Int32.Parse(textBox3.Text), Int32.Parse(textBox4.Text) });
